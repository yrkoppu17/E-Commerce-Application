    ...
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="glass p-8 rounded-3xl border border-slate-800 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-slate-400">Welcome back to ShopEZ</p>
        </div>
        ...
        <div className="border-t border-slate-800/80 pt-5 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="bg-slate-900 border border-slate-800 hover:border-slate-700 text-left p-2.5 rounded-xl text-xs transition-colors"
            >
              <div className="font-bold text-indigo-400">Customer Account</div>
            ...
            <button
              ...
              className="bg-slate-900 border border-slate-800 hover:border-slate-700 text-left p-2.5 rounded-xl text-xs transition-colors"
            >
              <div className="font-bold text-purple-400">Admin Account</div>
